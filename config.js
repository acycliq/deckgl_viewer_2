...
function config() {
    return {
        ...
        arrowSpotsManifest: "https://storage.googleapis.com/arrow_files/spots150_inef2.0_rSpot0.5_depthAdj/data/arrow/arrow_spots/manifest.json",
        arrowCellsManifest: "https://storage.googleapis.com/arrow_files/spots150_inef2.0_rSpot0.5_depthAdj/data/arrow/arrow_cells/manifest.json",
